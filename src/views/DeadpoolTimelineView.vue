...
<template>
  <div class="">
    ...
    <router-link to="/tesseract" class="fixed bottom-4 left-4 text-gray-400 hover:text-white transition text-2xl">
      ⬅️
    </router-link>

    <router-link to="/loki" class="fixed bottom-4 right-4 text-gray-400 hover:text-white transition text-2xl">
      ➡️
    </router-link>
